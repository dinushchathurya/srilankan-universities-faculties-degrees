...
namespace Devninja\University;

class University{
	
	public static function getUniversities(){
        return array_keys(self::$University);
    }

    public static function getFaculties($university){
        return array_keys(self::$University[$university]);
    }

    public static function getDegrees($faculty){
        foreach(self::$University as $university => $curFaculty){
            if(in_array($faculty,array_keys($curFaculty))){
                return $curFaculty[$faculty];
            }
        }
    }
      public static $University = array(
        'University of Colombo' => array(
            'Faculty of Arts' =>
            array(
        ...
        array(
            ...
            array(
                ...
                'Bachelor of Performing Arts (Special) Degree in Bharatha Nattyam',
        ...
        array(
            ...
            array(
                ...
                'Bachelor of Science in Tea Technology & Value Addition', 
                'BBM in Enterpreneurship and Management',
                'BBM in Hospitality Tourism and Event Management',
                'BSc in Mineral Resources and Technology',
                'BTech in Science and Technology',
            ),
        ),
        'Vavuniya Campus' =>
        array(
